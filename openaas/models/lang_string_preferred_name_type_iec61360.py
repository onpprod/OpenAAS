...
class LangStringPreferredNameTypeIec61360(AbstractLangString):
    """Model for LangStringPreferredNameTypeIec61360 in the AAS metamodel.

    Constraints:
    - Field set is aligned with definition `LangStringPreferredNameTypeIec61360` from aas.json.
